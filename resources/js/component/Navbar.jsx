...
const handleClick = () => {
    // hardcode refresh page redirect to admin page /admin
        ...
        <nav className="navbar md:px-[150px] px-6 flex justify-center transition-all duration-300 fixed top-0 left-0 right-0 z-50 py-3">
            <div className="rounded-full px-4 md:pr-3 md:pl-4 py-2 flex items-center justify-between max-w-7xl w-full bg-white shadow">
                ...
                <div className="hidden lg:flex">
                    <button
                        onClick={
                            // hardcode refresh page
                            handleClick
                        }
                        className="bg-green hover:bg-HoverGreen text-white px-6 py-2 rounded-full transition duration-200"
                    >
                        Masuk
                    </button>
                </div>
            ...
            >
                <div className="flex flex-col space-y-4 p-4">
                    ...
                    <button
                        onClick={handleClick}
                        className="bg-green hover:bg-HoverGreen text-white px-4 py-2 rounded-full transition duration-200"
                    >
                        Masuk
                    </button>
                </div>
